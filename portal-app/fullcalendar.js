...
DayGrid.mixin({
	...
	fgSegHtml: function(seg, disableResizing) {
		...
		titleHtml =
			'<span class="fc-title">'+
			'<input id="breakfast" type="checkbox" name="breakfast" value="breakfast" checked>BreakFast<br>'+
			'<input id="lunch"  type="checkbox" name="lunch" value="lunch" checked>Lunch<br>' +
			//'<input id="dinner" type="checkbox" name="dinner" value="dinner" checked>Dinner<br>' +
